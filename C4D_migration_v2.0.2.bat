...
echo Migrating Custom Global PopUp Menu
echo:
if exist "%appdata%\Maxon\Maxon Cinema 4D %prevInstallVer%_%prevInstallDir%\prefs\c4d_M_GLOBAL_POPUP.res" (
    Xcopy "%appdata%\Maxon\Maxon Cinema 4D %prevInstallVer%_%prevInstallDir%\prefs\c4d_M_GLOBAL_POPUP.res" "%appdata%\Maxon\Maxon Cinema 4D %installVer%_%installDir%\prefs\c4d_M_GLOBAL_POPUP.res" /E /H /C /I
) else (
