...
:: 3.0.1 (09.10.2025) - Update for Cinema 4D 2026.

echo ---- CINEMA 4D MIGRATION --- RUN AS ADMIN --- CLOSE WINDOW TO CANCEL ----
echo:

echo What release of C4D are you updating from? (i.e R26, 2024, 2025)
...
echo What release of C4D are you migrating to? (i.e. 2025, 2026 or TEST)
set /p installVer= - 
echo:
